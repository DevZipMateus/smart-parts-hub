      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
          <div className="flex-1 text-center md:text-left w-full">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 font-display tracking-wider text-gradient-primary text-glow-primary">
              SMART PARTS NH LTDA
            </h1>
              ...
              <a
                ...
                onClick={() => {
                  ...
                  if (typeof w.gtag === 'function') {
                    w.gtag('event', 'conversion', {'send_to': 'AW-17990045176/irIqCPXzw4IcEPibqYJD'});
                  }
                }}
              >
                <Phone size={20} />
